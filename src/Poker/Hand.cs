...
namespace Poker
{
    class Hand
    {
        ...
        public Card HighCard
        {
            get
            {
                ...
                _cards.Sort(HighestToLowest.Instance);
    ...
    class HighestToLowest : IComparer<Card>
    {
        private HighestToLowest()
        {
        }
        ...
        public int Compare(Card x, Card y)
        {
            if (x.Value > y.Value)
                return 1;
            else if (x.Value == y.Value && x.Suit > y.Suit)
                return 1;
            else if (x.Value == y.Value && x.Suit == y.Suit)
                return 0;
            else
        ...
        public static HighestToLowest Instance
        {
            get
            {
                return _instance;
        ...
        private static readonly HighestToLowest _instance = new HighestToLowest();
    }
}
