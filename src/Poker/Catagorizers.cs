...
namespace Poker
{
    class EndOfChainCardCatagorizer : HandCatagorizer
    {
        private EndOfChainCardCatagorizer()
        {
        }
        ...
        public static EndOfChainCardCatagorizer Instance
        {
            get
            {
                return _instance;
        ...
        private static readonly EndOfChainCardCatagorizer _instance = new EndOfChainCardCatagorizer();
    }
